				...
				<div className="row">
					<div className="col-xl-12">
						<div className="project-details__content-left">
							...
							<h3 className="mb-4 mt-5">DESTINATAIRES : 16 coopératives CACAO dans le bas Sassandra CI</h3>
							...
							<p className="mb-5">
							Implémenter le Système de Management pour garantir l’approvisionnement des matières premières à l’usine et assurer la traçabilité.<br />

							Description des services réels fournis par votre personnel dans le cadre de la mission :
